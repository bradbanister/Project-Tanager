...
### 4. Natural Key Resolution Through Views
...
- Views of flattened tables JOIN to provide natural key view of cross-resource references
...
- The following become reserved names: `Id`, `DocumentUuid`, `DocumentPartitionKey`
